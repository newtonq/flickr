...
function uploadPhoto($path, $title) {
    ...
    $apiSecret = "ec7a5957ac8a4e4b";
    $permissions  = "write";
    $token        = "72157632342031085-e26df89fe3e0c739";
...
if (isset($_POST['name']) && $error==0) {
    echo "  <h2>Your file has been uploaded to <a href='http://www.flickr.com/photos/91539127@N04/' target='_blank'>Nivesh Kumar's photo stream</a></h2>";
}else {
    if($error == 1){
...
?>
  <h2>Upload your Pic!<a href="gallery">Gallery</a></h2>
